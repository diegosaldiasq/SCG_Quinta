...
urlpatterns = [
    ...
    path('graficos_prelistos/', views.graficos_control_pesos_prelistos, name='graficos_control_pesos_prelistos'),
    path('api/productos/', views.api_productos_por_cliente_prelistos, name='api_productos_por_cliente_prelistos'),
    path('api/datos/', views.api_graficos_control_pesos_prelistos, name='api_graficos_control_pesos_prelistos'),
